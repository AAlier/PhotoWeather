...
inline fun <reified T> Intent.getArg(key: String, defaultValue: T? = null) =
    extractFromBundle(extras, key, defaultValue)

inline fun <reified T> Bundle.getArg(key: String, defaultValue: T? = null) =
    extractFromBundle(this, key, defaultValue)